...
class _Detail_TanamanState extends State<Detail_Tanaman> {
  ...
  Future<void> _checkFavoriteStatus() async {
    ...
    try {
      ...
      final tanamanId = widget.tanaman.id_tanaman.toString();

      FavoritModel? favorit;
      try {
        favorit = favoritList.firstWhere(
          (favorit) => favorit.id_tanaman == tanamanId,
        );
      } catch (e) {
        favorit = null; 
      }
      ...
      print('Status favorit untuk tanaman $tanamanId: $isFavorited');
    } catch (e) {
  ...
  final favorit = FavoritModel(
    id_favorit: '',
    id: userId!,
    id_tanaman: widget.tanaman.id_tanaman.toString(),
    id_ramuan: '',
    id_produk: '',
    id_penyakit: '',
    id_tips: '',
